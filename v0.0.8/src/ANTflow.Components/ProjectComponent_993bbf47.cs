...
{
  public sealed class ProjectComponent_993bbf47 : ProjectComponent_Base
  {
    static readonly string s_scriptDataId = "993bbf47-478e-4ffc-9d90-d97c61ccbefd";
    ...
    public override Guid ComponentGuid { get; } = new Guid("993bbf47-478e-4ffc-9d90-d97c61ccbefd");

    public override GH_Exposure Exposure { get; } = GH_Exposure.primary;

    public override bool Obsolete { get; } = false;

    public ProjectComponent_993bbf47() : base(GetResource(s_scriptDataId), s_scriptIconData,
        name: "OSM",
        nickname: "OSM",
        description: @"",
        category: "ANTflow",
