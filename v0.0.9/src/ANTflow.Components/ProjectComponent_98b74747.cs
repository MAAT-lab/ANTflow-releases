...
{
  public sealed class ProjectComponent_98b74747 : ProjectComponent_Base
  {
    static readonly string s_scriptDataId = "98b74747-27ce-440b-af04-6f7f8f83ced3";
    ...
    public override Guid ComponentGuid { get; } = new Guid("98b74747-27ce-440b-af04-6f7f8f83ced3");

    public override GH_Exposure Exposure { get; } = GH_Exposure.primary;

    public override bool Obsolete { get; } = false;

    public ProjectComponent_98b74747() : base(GetResource(s_scriptDataId), s_scriptIconData,
        name: "Meshy",
        nickname: "Meshy",
        description: @"Text to 3D model or Image to 3D model using Meshy. v0.1",
        category: "ANTflow",
        subCategory: "Default"
        )
    {
